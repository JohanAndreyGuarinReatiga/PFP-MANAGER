  ...
  static async cambiarEstado(id, nuevoEstado) {
    ...
    try {
      await session.withTransaction(async () => {
        ...
        entregable.cambiarEstado(nuevoEstado); // modifica estado y fechaEntrega si aplica

        // Actualizar entregable
        await entregables.updateOne(
          { _id: new ObjectId(id) },
          { $set: { estado: entregable.estado, fechaEntrega: entregable.fechaEntrega } },
          { session }
        );
